<?php
$certFile = '/etc/pki/tls/certs/apache.crt';
...
<title>Apache Lab - CyberArk Certificate Manager</title>
<style>
...
<div class="container">
  <section class="hero">
    ...
    <h1>Apache HTTPD<br><span class="gradient">Certificate Automation</span></h1>
    <p>Automated certificate lifecycle management powered by CyberArk Certificate Manager. This Apache server demonstrates machine identity security for enterprise Linux web workloads.</p>
    <div class="hero-tags">
      <span class="tag accent">Apache HTTPD</span>
      <span class="tag blue">HTTPS &middot; Port 443</span>
  ...
  <div class="cards">
    <div class="card"><div class="card-icon orange">&#128274;</div><h3>Certificate Provisioning</h3><p>CyberArk Certificate Manager issues and renews certificates automatically. Certificates are pushed directly to Apache with zero manual intervention required.</p></div>
    <div class="card"><div class="card-icon blue">&#9881;</div><h3>Agentless &amp; Agent-Based</h3><p>Supports both agentless (SSH-based) and agent-based certificate delivery. Certificate Manager handles the full install, reload, and verification cycle on Linux servers.</p></div>
  ...
  <div class="info-strip">
    ...
    <div class="info-item"><span class="info-label">Server</span><span class="info-value">Apache HTTPD (CentOS 7)</span></div>
    <div class="info-item"><span class="info-label">Port</span><span class="info-value">443 HTTPS</span></div>
